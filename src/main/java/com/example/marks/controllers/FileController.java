...
public class FileController {
    ...
    private void createExcelFile(String filePath) throws IOException {
        ...
        XSSFRow row;
        Map<String, Object[]> cadetData = new TreeMap<>();
        cadetData.put("1", new Object[] { "Name", "Surname", "City" });

        int i = 1;
        for (Cadet cadet : repository.findAll()) {
            cadetData.put(String.valueOf(i + 1), new Object[] { cadet.getName(), cadet.getSurname(), cadet.getMarks() });
            i++;
        }
    ...
    private void createPDFFile(String filePath) throws IOException {
        ...
        try {
            ...
            PdfPCell cell3 = new PdfPCell(new Phrase("Marks"));
            ...
            for (Cadet cadet : repository.findAll()) {
                ...
                PdfPCell cellMarks = new PdfPCell(new Phrase(cadet.getMarks()));

                table.addCell(cellName);
                table.addCell(cellSurname);
                table.addCell(cellMarks);
            }
